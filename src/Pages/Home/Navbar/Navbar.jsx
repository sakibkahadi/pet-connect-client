...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      ...
      <li>
        <NavLink to="/donationCampaigns">Donation Campaign</NavLink>
      </li>
      {!user?.email && (
        <li>
    ...
    <div className="navbar">
      <div className="navbar-start    ">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className={`text-[#1dc753] font-bold menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 duration-1000 absolute 
            ${open ? "" : "-top-60"}`}
          >
            {navLinks}
          </ul>
        ...
        <div className="flex items-center gap-1">
          ...
          <a
            className="  normal-case text-xl md:text-2xl  lg:text-4xl font-italic 
                    text-[#1461c5fe] font-extrabold "
          >
            PetConnect
          </a>
        </div>
